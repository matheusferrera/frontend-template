...
const ColorPicker = forwardRef(({ colors, selected, onSelectColor, limit = "auto", sx, ...other }, ref) => {
  ...
  const handleSelect = useCallback(
    color => {
      if (singleSelect) {
        ...
        const newSelected = selected.includes(color) ? selected.filter(value => value !== color) : [...selected, color];
