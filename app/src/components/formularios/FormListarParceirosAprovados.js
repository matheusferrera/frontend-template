...
import { dadosParceirosAprovados } from "./dadosMockados";
...
const FormListarParceirosAprovados = ({ servicosModal, setServicosModal }) => {
...
FormListarParceirosAprovados.propTypes = {
  setServicosModal: PropTypes.func,
  servicosModal: PropTypes.bool,
};

export default FormListarParceirosAprovados;
